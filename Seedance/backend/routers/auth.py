...
async def register(req: RegisterRequest):
    ...
    try:
        ...
        # 🎁 Free trial: 30 credits (~1 full Kling video + extras) for new users
        try:
            await store.topup_balance(user_id, 3000, tx_type="gift",
                                      note="Free trial: 30 credits. Welcome to see4dance!")
