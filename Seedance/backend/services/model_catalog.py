...
VIDEO_DRAFT_MODELS = {
    ...
    "veo3-fast": {
        "provider": "evolink",
        "evolink": "veo3-fast",
        "display_cn": "Veo 3 Fast (Google)",
        "display_en": "Veo 3 Fast (Google)",
        "price_per_sec_cn": {"720p": 200, "1080p": 450},
        "price_per_sec_intl": {"720p": 28, "1080p": 62},
        "tags": ["google", "premium"],
    },
    "veo3.1-fast": {
        "provider": "evolink",
        "evolink": "veo3.1-fast",
        "display_cn": "Veo 3.1 Fast (最强实时)",
        "display_en": "Veo 3.1 Fast (Top Real-time)",
        "price_per_sec_cn": {"720p": 250, "1080p": 520},
        "price_per_sec_intl": {"720p": 35, "1080p": 72},
        "tags": ["google", "best", "premium"],
    },
    "sora-2": {
        "provider": "evolink",
        "evolink": "sora-2",
        "display_cn": "Sora 2 (OpenAI)",
        "display_en": "Sora 2 (OpenAI)",
        "price_per_sec_cn": {"720p": 300, "1080p": 600},
        "price_per_sec_intl": {"720p": 42, "1080p": 83},
        "tags": ["openai", "premium"],
    },
    "kling-o3": {
        "provider": "evolink",
        "evolink": "kling-o3-text-to-video",
        "display_cn": "Kling O3 (快手)",
        "display_en": "Kling O3 (HQ)",
    ...
    "wan-2.7": {
        "provider": "evolink",
        "evolink": "wan2.7-text-to-video",
        "display_cn": "Wan 2.7 (阿里·最新)",
        "display_en": "Wan 2.7 (Alibaba·Latest)",
        "price_per_sec_cn": {"720p": 160, "1080p": 350},
        "price_per_sec_intl": {"720p": 22, "1080p": 48},
        "tags": ["new", "balanced"],
    },
    "wan-2.6": {
        "provider": "evolink",
        "evolink": "wan2.6-text-to-video",
    ...
    "hailuo-2.3": {
        "provider": "evolink",
        "evolink": "MiniMax-Hailuo-2.3",
        "display_cn": "Hailuo 2.3 (海螺·写实)",
